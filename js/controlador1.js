...
function tabbtn(){
    document.getElementById('destinations').removeAttribute('style', 'display');
    document.getElementById('destinations').style.display='block';
    document.getElementById('destacados').style.display='none';
    document.getElementById('destinations-btn').removeAttribute('style', 'display');
    document.getElementById('destinations-btn').style.display='block';
    document.getElementById('destacados-btn').style.display='none';
}
function tabbtn1(){
    document.getElementById('destacados').removeAttribute('style', 'display');
    document.getElementById('destacados').style.display='block';
    document.getElementById('destinations').style.display='none';
    document.getElementById('destacados-btn').removeAttribute('style', 'display');
    document.getElementById('destacados-btn').style.display='block';
    document.getElementById('destinations-btn').style.display='none';
}

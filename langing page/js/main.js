$(document).ready(function() {
    $.ajax({
        url:"ajax/hoteles.php?accion=obtener",
        dataType:"json",
            ...
            for(var i=0;i<respuesta.length;i++){
                ...
                <section class="hotelBasic">
                    ...
                    <section class="hotelInfo">
                        ...
                        <span class="stars">${respuesta[i].numeroEstrellas} <span class="hotelText">${respuesta[i].tipo}</span></span>
...
let days;
    ...
    $.ajax({
		url:"ajax/ubicaciones.php?accion=ubicacion",
		dataType:"json",
		success:function(respuesta){
			console.log(respuesta);
			for(var i=0;i<respuesta.length;i++){
    ...
    $.ajax({
		url:"ajax/puntuaciones.php?accion=puntos",
		dataType:"json",
		success:function(respuesta){
			console.log(respuesta);
			for(var i=0;i<respuesta.length;i++){
				$("#rate").append(`<option value="${respuesta[i].codigoCalificacion}">${respuesta[i].calificacion}</option>`);
				$("#rate").val(null);
			}
		},
		error:function(error){
    ...
    $.ajax({
		url:"ajax/estrellas.php?accion=estrella",
		dataType:"json",
		success:function(respuesta){
			console.log(respuesta);
			for(var i=0;i<respuesta.length;i++){
				$("#type").append(`<option value="${respuesta[i].codigoEstrella}">${respuesta[i].estrellas}</option>`);
				$("#type").val(null);
			}
		},
		error:function(error){
...
$("#location").change(function(){
	$("#hotels").html("");
	$.ajax({
		url:"ajax/ubicaciones.php?accion=listaSeleccionada&codigoLocalizacion="+$("#location").val(),
		dataType:"json",
		success:function(respuesta){
            console.log(respuesta);
            var x=1;
...
$("#rate").change(function(){
	$("#hotels").html("");
	$.ajax({
		url:"ajax/puntuaciones.php?accion=puntuacionSeleccionada&codigoCalificacion="+$("#rate").val(),
		dataType:"json",
		success:function(respuesta){
            console.log(respuesta);
            var x=1;
...
$("#type").change(function(){
	$("#hotels").html("");
	$.ajax({
		url:"ajax/estrellas.php?accion=estrellaSeleccionada&codigoEstrella="+$("#type").val(),
		dataType:"json",
		success:function(respuesta){
            console.log(respuesta);
            var x=1;
